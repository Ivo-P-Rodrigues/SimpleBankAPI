...
{
    public class AccountDocRepository : CommonRepository<AccountDoc>, IAccountDocRepository
    {
        public AccountDocRepository(SimpleBankDbContext context, ILogger logger) : base(context, logger)
        {
        }
