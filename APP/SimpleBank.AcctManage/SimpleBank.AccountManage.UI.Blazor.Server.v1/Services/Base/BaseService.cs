...
namespace SimpleBank.AccountManage.UI.Blazor.Server.v1.Services.Base
{
    public abstract class BaseService
    {
        ...
        public async Task<bool> RegisterLogoutAsync()
        {
        ...
        public async Task<bool> CheckLocallyIfUserIsLoggedAsync()
        {
